...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "emmet-vim", "cmp-path", "cmp-cmdline", "cmp-buffer", "cmp-spell" },
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'neotest', 'vim-visual-multi', 'vim-surround', 'vim-repeat', 'vim-maximizer'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'no-neck-pain.nvim', 'neorg', 'zen-mode.nvim'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'friendly-snippets', 'nvim-cmp', 'copilot.vim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
